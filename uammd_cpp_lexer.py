...
class CFamilyLexer2(RegexLexer):
    """
    ...
    tokens = {
        ...
        'statements': [
            ...
            (words(('asm', 'auto', 'break', 'case', 'const', 'continue',
                   ...
                   suffix=r'\b'), Keyword),
            (r'(bool|int|long|float|short|double|char|unsigned|signed|void|uint|real4|real3|real2|int2|int3|int4)\b',
             Keyword.Type),
...
class UAMMDCppLexer(CFamilyLexer2):
    """
    ...
    tokens = {
        ...
        'enumname': [
            ...
            (CFamilyLexer2._ident, Name.Class, '#pop'),
            # template specification
            (r'\s*(?=>)', Text, '#pop'),
            default('#pop')
        ]
