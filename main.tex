...
\emph{Potential} serves as a way to serve \emph{Transversers} to \emph{Interactors}. In particular, the \emph{PairForces} module (see chapter \ref{sec:shortrange}) needs a \emph{Potential} encoding the specific particle interaction.
