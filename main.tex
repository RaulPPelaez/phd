...
\begin{equation}
  \rho\int_{V_p}\partial_t\vec{\fvel}d\vec{\fpos}^3 0 -\int_{V_p}\nabla\cdot\tens{\sigma}d\vec{r}^3 + \int_V\vec{f}d\vec{\fpos}^3
\end{equation}
Note that
