...
\uammd attempts to be provide an \emph{open} ecosystem, exposing most of the underlying algorithms in a library-like fashion. From a software perspective, this is one of the main vantage points of \uammd as compared with similar packages.
