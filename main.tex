...
Note that for algorithm \ref{alg:visitneigh} we have decided to traverse, for each particle, all nearby

algorithm \ref{alg:visitneigh} works for a serial implementation as is. However, if
