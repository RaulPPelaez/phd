...
\begin{figure}[h]
  \centering
  %\includegraphics[width=\textwidth]{landscape}
  \includesvg{gfx/modular}{0.8\columnwidth}
...
\begin{figure}
  \centering
  %\includegraphics[width=\textwidth]{landscape}
  \includesvg{gfx/sketchUAMMD_interactors}{\columnwidth}
  \caption{The next level in the \emph{Interactor} branch of the tree presented at fig. \ref{fig:uammdsketch}.}
...
\begin{figure}
  \centering
  %\includegraphics[width=\textwidth]{landscape}
  \includesvg{gfx/sketchUAMMD_integrators}{0.7\columnwidth}
