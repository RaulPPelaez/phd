...
Note tfou any smooth, closely-supported kernel can be used here instead of a Gaussian, which will regularize differently the near field hydrodynamics.
...
Making an analogy with eq. \eqref{eq:bdhibdrelation}, the whole algorithm can the be summarized as follows:
