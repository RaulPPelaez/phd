...
\newtcblisting[list inside=code2, auto counter]{code2}[2][]{
  colback=white,
  colbacktitle=white,
  coltitle=black,
  breakable,
...
The benefit of using the same kernel to spread and interpolate is that both are adjoint, $\oper{J} = \oper{S}^*$, which is required in the following derivation.
